<template>
	<view class="uni_calendar">
		<cu-custom bgColor="bg-gradual-blue"><view slot="content">日历</view></cu-custom>
		<Calendar :startDate="start" :themeColor="'#267656'" :priceList="priceList" :endDate="end" @callback="getDate" :mode="1" class="calendar">
			<view>
